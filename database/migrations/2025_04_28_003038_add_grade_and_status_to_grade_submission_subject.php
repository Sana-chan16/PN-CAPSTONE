...
return new class extends Migration
{
    public function up()
    {
        Schema::table('grade_submission_subject', function (Blueprint $table) {
            // Columns 'grade', 'status', and 'user_id' already exist, so do not add them again.
            // Only add new constraints or modifications if needed.
    ...
    {
        Schema::table('grade_submission_subject', function (Blueprint $table) {
            // Columns 'grade', 'status', and 'user_id' already exist, so do not drop them again.
            // Only drop new constraints or modifications if needed.
